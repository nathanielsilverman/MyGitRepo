...
public class TrieImpl<Value> implements Trie<Value> {
    ...
    public Set<Value> deleteAllWithPrefix(String prefix) {
        ...
        List<Value> allWithPrefix = getAllWithPrefix(prefix.toUpperCase());
        ...
        removeSubtree(prefix.toUpperCase());
        return valueSet;
    }
    ...
    private void removeSubtree(String keyword){
        ...
        String keywor = keyword.substring(0, keyword.length()-1);
        Node<Value> node = this.get(this.root, keywor, 0);
